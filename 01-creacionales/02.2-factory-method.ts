...
class SalesReport implements Report {
    generate(): void {
      console.log('Generando %creporte de %cventas...', COLORS.orange);
    }
...
class InventoryReport implements Report {
  generate(): void {
    console.log('Generando %creporte de %cinventario...', COLORS.pink);
  }
}

class InvoiceReport implements Report {
  generate(): void {
    console.log('Generando %creporte de %cfacturacion...', COLORS.blue);
  }
}
...
class InvoiceReportFactory extends ReportFactory {
  createReport(): Report {
...
function main() {
  ...
  const reportType = prompt(
    '¿Qué tipo de reporte deseas? %c(sales/inventory/invoice)'
  );
  ...
  if (reportType === 'sales') {
    ...
    reportFactory = new InvoiceReportFactory();
  }
  else {
